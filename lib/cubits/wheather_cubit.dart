  ...
  Future<void> fetchWeatherDataFromApi({required String cityName}) async {
    ...
    try {
      final response = await http.get(
        Uri.parse(
          '${AppConstants.kWeatherApiBaseUrl}${AppConstants.kWeatherApiEndpoint}?key=${AppConstants.kWeatherApiKey}&q=$cityName&${AppConstants.kFixedWeatherApiQueryParam}',
        ),
      );
      ...
      if (response.statusCode == 200) {
        ...
        WeatherEntity weatherModel = WeatherEntity.fromJson(decodedResponse);
